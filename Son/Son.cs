...
public static void GererImage(TextBox textBox, Label label1, Label label24, Label label2, Label label3, Label label4, Label label5, Label label6, Label label7, Label label8, Label label9, Label label10,
    Label label11, Label label12, Label label13, Label label14, Label label15, Label label16, Label label17, Label label18, Label label19, Label label20, Label label21, Label label22, Label label23)
{
    ...
    moyenBass0_20 = moyenBass0_20 / 10;

    listPuiss.Add(moyenBass0_20);
    ...
    if (moyenBass0_20 > puissanceMax)
    {
        puissanceMax = (int)moyenBass0_20;
    ...
    if (moyenBass0_20 > 1.84 * moyennePuissance)
    {
